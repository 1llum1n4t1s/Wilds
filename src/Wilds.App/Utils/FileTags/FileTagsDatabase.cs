...
using static Wilds.App.Helpers.RegistryHelpers;
using static Wilds.App.Utils.FileTags.TaggedFileRegistry;
...
namespace Wilds.App.Utils.FileTags
{
	public sealed class FileTagsDatabase
	{
		...
		private string? FileTagsKey => _FileTagsKey ??= SafetyExtensions.IgnoreExceptions(() => @$"Software\Files Community\{WildsAppInfo.PackageName}\v1\FileTags");
