...
using Wilds.App.Utils.Serialization.Implementation;
using System.IO;
using Windows.Storage;

namespace Wilds.App.Services.Settings
{
	internal sealed class UserSettingsService : BaseJsonSettings, IUserSettingsService
	{
		...
		public UserSettingsService()
		{
			...
			Initialize(Path.Combine(AppPaths.LocalFolderPath, Constants.LocalSettings.SettingsFolderName, Constants.LocalSettings.UserSettingsFileName));
