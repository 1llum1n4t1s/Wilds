			...
			switch (activatedEventArgs)
			{
				case ILaunchActivatedEventArgs launchArgs:
					if (launchArgs.Arguments is not null &&
						...
						|| CommandLineParser.SplitArguments(launchArgs.Arguments, true)[0].Equals(Path.Join(WildsAppInfo.InstalledPath, "Wilds.exe"), StringComparison.OrdinalIgnoreCase)))
					{
