...
using Wilds.App.Helpers.ContextFlyouts;
using Wilds.App.UserControls.Menus;
using Wilds.App.ViewModels.Layouts;
...
using static Wilds.App.Helpers.PathNormalization;
using DispatcherQueueTimer = Microsoft.UI.Dispatching.DispatcherQueueTimer;
using SortDirection = Wilds.App.Data.Enums.SortDirection;
using VanaraWindowsShell = Vanara.Windows.Shell;

namespace Wilds.App.Views.Layouts
{
	/// <summary>
