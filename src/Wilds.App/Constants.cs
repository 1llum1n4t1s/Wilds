...
namespace Wilds.App
{
	public static class Constants
	{
		...
		public static class AssetPaths
		{
			...
			public const string StableLogo = "Assets/AppTiles/Dev/Logo.ico";
		}
		...
		{
			// Wilds フォーク固有のリンク。 issue/feature request/sponsor/release は fork リポジトリに向ける。
			public const string GitHubRepoUrl = @"https://github.com/1llum1n4t1s/Wilds";
			public const string DocumentationUrl = @"https://github.com/1llum1n4t1s/Wilds#readme";
			public const string DiscordUrl = @"https://github.com/1llum1n4t1s/Wilds/discussions";
			public const string FeatureRequestUrl = @"https://github.com/1llum1n4t1s/Wilds/issues/new?labels=feature+request";
			public const string BugReportUrl = @"https://github.com/1llum1n4t1s/Wilds/issues/new?labels=bug";
			public const string PrivacyPolicyUrl = @"https://github.com/1llum1n4t1s/Wilds#readme";
			public const string SupportUsUrl = @"https://github.com/1llum1n4t1s/Wilds";
			public const string CrowdinUrl = @"https://github.com/1llum1n4t1s/Wilds";
			public static readonly string ReleaseNotesUrl = $"https://github.com/1llum1n4t1s/Wilds/releases/tag/{WildsAppInfo.Version.Major}.{WildsAppInfo.Version.Minor}.{WildsAppInfo.Version.Build}";
		}
		...
		public static class Startup
		{
			...
			public const string MissingRuntimeMessage = "Wilds failed to start. A required Windows component could not be loaded. Try reinstalling Wilds from https://github.com/1llum1n4t1s/Wilds/releases/latest";
			public const string MissingRuntimeTitle = "Wilds - Startup Error";
		}
	}
}
