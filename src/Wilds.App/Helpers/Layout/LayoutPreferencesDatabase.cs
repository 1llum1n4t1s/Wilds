...
using static Wilds.App.Helpers.LayoutPreferencesDatabaseItemRegistry;
...
namespace Wilds.App.Helpers
{
	...
	{
		private readonly static string LayoutSettingsKey = @$"Software\Files Community\{WildsAppInfo.PackageName}\v1\LayoutPreferences";
