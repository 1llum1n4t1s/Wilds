...
using Wilds.App.UserControls.FilePreviews;
...
namespace Wilds.App.ViewModels.UserControls
{
	public sealed partial class InfoPaneViewModel : ObservableObject, IDisposable
	{
		...
		private void UpdateTagsItems()
		{
			...
			var contextMenu = new Wilds.App.UserControls.Menus.FileTagsContextMenu(new List<ListedItem>() { SelectedItem });
