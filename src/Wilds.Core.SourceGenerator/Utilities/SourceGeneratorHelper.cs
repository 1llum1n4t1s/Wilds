...
namespace Wilds.Core.SourceGenerator.Utilities
{
	/// <summary>
	...
	{
		internal const string AttributeNamespace = "Wilds.Shared.Attributes.";
		internal const string HelperNamespace = "Wilds.App.Helpers.";
		internal const string DisableSourceGeneratorAttribute = AttributeNamespace + "DisableSourceGeneratorAttribute";
		internal const string AssemblyName = "Wilds.SourceGenerator.";
